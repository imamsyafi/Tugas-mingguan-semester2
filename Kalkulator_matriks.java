...
public class Kalkulator_matriks extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel4.setText(": M. Imam Syafi'i");

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel5.setText(": 1955201146");

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText(": Ilmu Komputer");

        jLabel7.setIcon(new javax.swing.ImageIcon("D:\\BERKAS KULIAH\\LOGO UNU.png")); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        matriksA[0][1] = Integer.parseInt(A11.getText());
        matriksA[1][0] = Integer.parseInt(A11.getText());
        matriksA[1][1] = Integer.parseInt(A11.getText());

        int matriksB[][] = new int[2][2];
        matriksB[0][0] = Integer.parseInt(B11.getText());
        matriksB[0][1] = Integer.parseInt(B11.getText());
        matriksB[1][0] = Integer.parseInt(B11.getText());
        matriksB[1][1] = Integer.parseInt(B11.getText());

        int matriksC[][] = new int[2][2];

        if (jumlah.isSelected()) {
            for (int a = 0; a < matriksA.length; a++) {
                for (int s = 0; s < matriksA[0].length; s++) {
                    matriksC[a][s] = matriksA[a][s] + matriksB[a][s];
                }
            }
